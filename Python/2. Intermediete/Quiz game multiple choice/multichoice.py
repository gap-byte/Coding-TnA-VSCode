...
a ="\n Note: Type answers! do not write option."
score = 0
total_questions = 4
...
#Now as we are done with the questions it’s time to show the scores to the user. 
#I will multiply the score with 10 and then I will pass the if-else conditionals to print the status of the result of this Quiz game:
